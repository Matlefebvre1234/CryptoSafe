  ...
  return (
    <div className='p-5'>
      ...
      <Setting open={openSetting} setOpen={setOpenSetting}></Setting>
        ...
        {(loading || !web3.state_encryptionPubKey) && <CircularProgress></CircularProgress>}
        {!loading && web3.state_encryptionPubKey &&  listPassword && listPassword.map(password => <PasswordCard key={password.password} password={password} deletePassword={deletePassword} account={state_account} callback={fetchPassword}></PasswordCard> )}
