  ...
  return (
    <div className='p-5'>
      ...
      <div className='w-full'>
        ...
        <Card className='p-5 flex justify-center items-center bg-blue-400 ' >
        <span className='font-Concert text-white'> Your Contract Account :  </span>
           <span className='font-Cairo mx-2 text-white'>{state_account}</span> 
