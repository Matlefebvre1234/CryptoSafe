    ...
    <Paper elevation={4} className="">
      <div className="flex lg:justify-around justify-between px- p-5 items-center">
        <div className="flex justify-center items-center">
          <NeptuneLogo className="2xlg:w-32 2xlg:h-32 lg:w-24 lg:h-24 w-20 h-20 hover:transform hover:scale-110"></NeptuneLogo>
          <span className=" text-xl 2xlg:text-4xl text-cyan-300  font-Concert hover:text-blue-400 hover:transform hover:scale-105 antialiased">
            Neptune
          </span>
        </div>
