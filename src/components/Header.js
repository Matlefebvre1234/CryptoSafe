    ...
    <Paper elevation={4} className="">
      <div className="flex lg:justify-around justify-between px- p-5 items-center">
        <div className="flex justify-center items-center">
          <NeptuneLogo className="xlg:w-32 xlg:h-32 lg:w-24 lg:h-24 w-20 h-20 hover:transform hover:scale-110"></NeptuneLogo>
          <span className=" text-xl lg:text-4xl text-cyan-300  font-Concert hover:text-blue-400 hover:transform hover:scale-105 antialiased">
            Neptune
          </span>
        </div>
        ...
        <div className="lg:flex justify-center items-center hidden">
          <div className="flex justify-around mx-2">
            <Link
              to="/"
              className="mx-2 font-Cairo text-black  antialiased xl:text-xl  no-underline hover:text-cyan-400 hover:transform hover:scale-105  "
            >
              Dashboard
            </Link>
            <Link
            ...
            <Link
              to="/"
              className="mx-2 font-Cairo text-black antialiased xl:text-xl  no-underline hover:text-cyan-400 hover:transform hover:scale-105 hover: "
            >
              Contact us
            </Link>
          </div>
