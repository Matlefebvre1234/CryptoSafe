  ...
  return (
    <div className='p-5'>
      ...
      <div className='w-full'>
        ...
        <span className='font-Concert text-blue-400'> Your Contract Account :  </span>
           <span className='font-Cairo mx-2 text-black'>{state_account}</span> 
        ...
        variant="contained"
        className="bg-blue-400 hover:bg-blue-500 mx-2  font-Concert hover:transform hover:scale-105 font-Cairos text-xs"
