...
import { decryptWithFakeAddress, encryptWithFakeAddress} from "../helper/encrypt";
...
export default function NewPasswordButton({ callback, account }) {
  ...
  async function createPassword() {
    ...
    if(passwordContext.ref_doubleSecurity.current) {
      ...
      let test = await decryptWithFakeAddress(web3.ref_address.current,passwordContext.ref_doubleSecurity.current,encrypted);
