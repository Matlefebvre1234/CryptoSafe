  ...
  return (
    <div className="flex flex-col justify-center items-center w-full h-full">
      <div className="flex flex-col justify-center items-center w-1/2 h-1/2">
        <span className="text-xl text-center text-black font-Cairo">
        ...
        >
          <DialogTitle className="font-Cairo text-gray-400 ">Help
          <IconButton
          aria-label="close"
        ...
        <Dialog
          ...
          aria-describedby="alert-dialog-slide-description"
        >
          <DialogTitle className="font-Cairo text-gray-400 ">Reset Account
          <IconButton
          aria-label="close"
