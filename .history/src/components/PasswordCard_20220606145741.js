...
<div className="flex justify-between items-center w-full">
            ...
            <div
              ...
              className=" bg-sky-400 w-full h-7 shadow shadow-gray-400  flex justify-center items-center rounded-lg hover:bg-blue-500  text-white hover:transform hover:scale-105"
            >
              <EditIcon></EditIcon>
            </div>
            ...
            <div
              ...
              className=" bg-sky-400 w-ful h-7 shadow shadow-gray-400  flex justify-center items-center rounded-lg hover:bg-blue-500  text-white hover:transform hover:scale-105"
            >
