      ...
      <DialogContent className="flex  items-center justify-center p-5">
        {!loading && !created && (
          ...
          <div className="flex flex-col">
            ...
            size="medium"
            variant="contained"
            className="bg-red-500 hover:bg-blue-500 mx-2  font-Cairo hover:transform hover:scale-105"
      ...
      <DialogActions className="p-5">
        {!loading && !created && (
          <Button
            size="medium"
            variant="contained"
            className="bg-red-500 hover:bg-blue-500 mx-2  font-Concert hover:transform hover:scale-105"
            onClick={validInput}
          >
