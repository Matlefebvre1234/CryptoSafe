          ...
          <DialogContent>
            <div className="flex flex-col p-2 justify-center items-center text-gray-400 font-Cairo ">
              <p className="text-center my-10 font-Cairo">
                ...
                If you forgot your passsword you can reset your account with the reset button in the bottom. <br>Take note that all your passwords is going to be delete and you will note be able to recover them </br>
                </br> 
              </p>
             <Button
              size="medium"
