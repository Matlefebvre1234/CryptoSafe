  ...
  return (
    <div className='p-5'>
      ...
      <Setting open={openSetting} setOpen={setOpenSetting}></Setting>
        ...
        {!loading && listPassword && listPassword.map(password => <PasswordCard key={password.password} password={password} deletePassword={deletePassword} account={state_account} callback={fetchPassword}></PasswordCard> )}
