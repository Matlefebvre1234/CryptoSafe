        ...
        {!loading && !created && (
          <div className="flex flex-col justify-center items-center">
            <p className="text-justify m-10 font-Cairo leading-normal">
              You can enable Double security with a Master Password. This
              password will be use to encrypt and decrypt all your passwords.
              This way, if someone steal your private key, they will need this
              unique password to access your account.
              <br></br>
              <br></br>
              This process need to reset your account to enable this feature.
          ...
          {!loading && !created && (
            <div className="flex flex-col">
              <p className="text-justify mt-10 font-Cairo leading-normal">
                Enter a unique password. It's the only password you need to
                remember. If you lost it you will not be able to access your
                account anymore.
              </p>
              <TextField
                required
